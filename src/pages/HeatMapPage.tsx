    ...
    return (
        ...
        <Container>
            <div className="data-container text-center">
                <h4>Est-ce que certaines nations dominent des sports plus que d'autres dans les médailles?</h4>
                <h6>Choisisez un ou plusieurs sports et regardez comment les pays et leurs athlètes se comparent</h6>
            </div>
            <br />
            <div className="data-container">
                ...
                {selectedSports.length === 0 && <div style={{
                ...
                {selectedSports.length > 0 &&
                    <>
                        <MedalHeatmap data={data} selectedSports={selectedSports} nocRegions={nocRegions} scrollCountry={selectedCountry?.value} />
                    </>

                }
                {selectedSports.map((sport) => (
                    <ScatterPlot key={sport} data={data} selectedSport={sport} selectedCountry={selectedCountry?.value} nocRegions={nocRegions} />
                ))}
            </div>
        </Container>
        </>
