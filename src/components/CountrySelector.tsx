...
const CountrySelector: React.FC<Props> = ({ allCountries, selectedCountries, onAdd, onRemove }) => {
    ...
    const filteredSports = useMemo(() => {
        const available = allCountries.filter(s => !selectedCountries.includes(s));
        ...
        return available
            ...
            .slice(0, 20);
    }, [allCountries, selectedCountries, searchTerm]);
