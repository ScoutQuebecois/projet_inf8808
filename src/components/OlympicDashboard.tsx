    ...
    <div className="data-container ">
      <Container>
        <Row>
          <Col>
            <Select
              ...
              options={metriques.map((m) => ({
                value: m.value,
                label: m.label,
              }))}
              placeholder="Choisir une métrique"
              onChange={(option) =>
                setMetric(option ? (option.value as MetricType) : "Age")
              }
            />
          </Col>
          <Col>
            <Select
              ...
              onChange={(option) =>
                setSelectedSex(option ? option.value : "All")
              }
            />
          </Col>
        </Row>
        ...
        <Row className="align-items-end">
          ...
          <Col>
            <div>
              Choisir aucun sport dans la liste est équivalent à choisir tous
              les sports.
            </div>
          </Col>
        </Row>
